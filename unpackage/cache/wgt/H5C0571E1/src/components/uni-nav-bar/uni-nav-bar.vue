  ...
  <view class="uni-navbar">
    <view
      :class="{
        ...
        'uni-navbar__content_back': isBackgroundImg
      }"
        ...
        >
          <view
            ...
            :style="{
              ...
              'margin-left': textAlign === 'center' ? '120px' : '0'
            }"
          >
            <img
              v-if="!isIndex"
              class="uni-nav-bar-text-icon"
              src="../../static/gangpen.png"
              mode=""
            ></image>
            <text class="uni-nav-bar-text" :style="{ color: color }">{{
              title
            }}</text>
            <text v-if="!isIndex" class="uni-nav-bar-text-fu"
              >小学六年级下</text
            >
          </view>
          <!-- 标题插槽 -->
...
.uni-navbar__content_back {
  background: url(../../static/Group%20713.png);
