  ...
  S = function(e) {
    ...
    for (
      ...
      if ("M" === u[y][0])
        ...
        (this.length += Math.sqrt(Math.pow(u[y][1], 2) + Math.pow(u[y][2], 2))),
          this.functions.push(
        ...
        if (y > 0 && ["C", "c", "S", "s"].indexOf(u[y - 1][0]) > -1) {
          ...
          g = new _(l[0], l[1], l[0], l[1], u[y][1], u[y][2], u[y][3], u[y][4]);
        g &&
          ((this.length += g.getTotalLength()),
          (l = [u[y][3], u[y][4]]),
          this.functions.push(g));
